...
function adminContent(){
    ...
    <a href='../../admin/nhan-vien-vc/create.php' class='product-link--edit'>Thêm nhân viên mới</a>
</div>";
include("../../block/connection.php");
    ...
    $query = "SELECT * FROM nhanvien WHERE IdChuVu ='2'";
    $result = mysqli_query($conn, $query);
    $numRow = mysqli_num_rows($result);

    $maxPage = ceil($numRow / $rowsPerPage); 
    $query = "SELECT * FROM nhanvien WHERE IdChuVu ='2' LIMIT $offset, $rowsPerPage";
    $result = mysqli_query($conn, $query);
    if (!$result){
        ...
        if (!mysqli_num_rows($result)==0){
            ...
            while ($row=mysqli_fetch_array($result)){
                ...
                echo "<a href='../../admin/nhan-vien-vc/edit.php?id=".$row['IdNV']."'>";
                    ...
                    if($maxPage > 4)
                    {
                        if($_GET['page'] == 1)
                        {
                            ...
                            if($_GET['page'] == $maxPage)
                            {
                                ...
                                {
                                    echo "<span class='pa   ge-dot'>...</span>";
                                }
                            }
                        }
                    }
