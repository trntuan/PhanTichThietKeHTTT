...
function adminContent(){
    ...
    if (!$result){
        ...
        while ($row=mysqli_fetch_array($result)){
            ...
            $hoNV=$row['HoNV'];
            $tenNV=$row['TenNV'];
            $gioitinh=$row['GioTinh'];
            $sdt= $row['Sdt'];
            $date=$row['NgaySinh'];
            if ($row['anh']==null) $hinhAnh="personal.png";
    ...
    echo "<div class='product-content--link' align='left' style='margin-bottom: 30px'>";
            ...
            <a href='../../admin/nhan-vien-pc/index.php' class='product-link--edit'>
...
<div class="product-update--img">
    <img src="../../assets/images/team/<?php if (!isset($_FILES["res"])) echo $hinhAnh; 
    ?>" alt="" id="img">
    ...
    <input type="date" name="date" value="<?php
            if (isset($date)) echo $date; else echo "";
        ?>" class="product-update--input" >
    </td>
    </tr>
    </table>
